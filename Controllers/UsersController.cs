...
namespace BPMPlus.Controllers
{
	public class UsersController : BaseController
	{
		...
		private readonly userDetailData _userDetailData;

		public UsersController(ApplicationDbContext context,userDetailData userDetailData) : base(context)
		{
			_context = context;
		...
		{
			//所有的使用者集合
			var userslist =  _userDetailData.userData();
		...
		public async Task<IActionResult> Details(string id)
		{
			...
			var user = _userDetailData.userDetail(id);
